        ...
        <div className="text-white text-center">
          ...
          <div className="flex justify-center">
            <div className="sm:bg-white rounded-lg p-3 flex flex-col sm:flex-row items-center sm:space-x-3">
              ...
              <div className="flex flex-row mb-3 sm:mb-0 space-x-5 sm:space-x-0">
                <div className="relative flex items-center mb-2 sm:mb-0 sm:mr-3">
                  ...
                  <input
                    ...
                    className="pl-8 px-4 py-2 border-t-2 border-b-[1px] rounded-xl bg-white text-black border-gray-300 w-40"
                  />
                </div>
                <select className="px-4 py-2 border-t-2 border-b-[1px] rounded-xl bg-white text-gray-400 border-gray-300">
              ...
              <div className="flex flex-row mb-3 sm:mb-0 space-x-5 sm:space-x-0">
                <select className="px-4 py-2 border-t-2 border-b-[1px] rounded-xl bg-white text-gray-400 border-gray-300 mb-2 sm:mb-0 sm:mr-3">
