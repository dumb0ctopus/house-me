            ...
            <div>
              <div>
                <div className="flex items-center mb-2 justify-between py-5 px-7 border border-gray-200 shadow-sm rounded-lg">
                  ...
                  <div>
                    <h1 className="text-gray-600 hidden md:flex">Bedrooms</h1>
                  ...
                  <div>
                    <h1 className="text-gray-600 hidden md:flex">Bathrooms</h1>
                    <p className="text-gray-600 text-center font-bold">
                  ...
                  <div>
                    <h1 className="text-gray-600 hidden md:flex">
                      Car Park Holdings
                    </h1>
                    <p className="text-gray-600 text-center font-bold">
                  ...
                  <div>
                    <h1 className="text-gray-600 hidden md:flex">Tag</h1>
                    <p className="text-gray-600 text-center font-bold">
