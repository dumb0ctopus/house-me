  ...
  return (
    <nav className="flex items-center justify-between bg-white py-7 px-6 shadow-lg top-0 fixed w-full z-[2001]">
      ...
      <div className="md:flex space-x-6 hidden">
        ...
        <Link
          to="/home"
          className={`text-black font-halant text-lg font-semibold py-2 px-5 border-2 border-transparent hover:rounded-3xl hover:text-white hover:border-2 ${
          ...
          <div className="absolute right-0 mt-[39%] -mr-3 w-60 bg-white rounded-xl shadow-lg z-10">
            <div>
              ...
              >
                ...
                <h2 className="block font-semibold font-halant text-base text-gray-700 ">
                  Profile
                </h2>
              </Link>
              <Link
              ...
              >
                ...
                <h2 className="block font-semibold text-base text-gray-700 font-halant">
                  Account Settings
                </h2>
              </Link>
              <Link
